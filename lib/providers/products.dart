...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url = 'https://grocery-app-70eec.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
      ...
      url =
      'https://grocery-app-70eec.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url = 'https://grocery-app-70eec.firebaseio.com/products.json?auth=$authToken';
    try {
